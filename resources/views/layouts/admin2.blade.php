...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    text-align: center;
            ...
            .alternative:hover,.alternative.selectedoption{
                cursor: pointer;
                background:#ebc89b;
            }
            .this-check{
    ...
    margin: 0 auto;
            ...
            .bg-question img{
                max-width: 100%;    max-height: 278px;
                text-align: center;
    width: 100%;
    object-fit: contain;
    background: white;
            ...
            <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
                ...
                <div class="flex-1 flex flex-col overflow-hidden min-h-screen">
                    ...
                    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 relative">
                        @yield('content2')
                        <div class="block md:flex w-full h-full">
                            
                            <div class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 relative">
                                @yield('content')
                            </div>
                            <div class="w-full h-screen md:h-auto md:w-72 relative ">
                                @yield('chat')
                            </div>
                        </div>
