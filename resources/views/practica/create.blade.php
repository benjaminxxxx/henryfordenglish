...
<script>
    ...
    function getOption(index){
        ...
        div+= '<input type="text" autocomplete="off" style="    padding-right: 124px !important;" placeholder="Coloca una opción" name="option[]"  class="{{$input_class}}"><div class="imagen_option_preview"></div>';
        if(index!=1){
    ...
    function putOption(index,value,ischecked){
        var div = '<div class="w-full pr-relative">';
        div+= '<div class="relative">';
        div+= '<input type="text" autocomplete="off" value="'+value+'" style="    padding-right: 124px !important;" placeholder="Coloca una opción" name="option[]"  class="{{$input_class}}"><div class="imagen_option_preview"></div>';
        if(index!=1){
            div+= '<a href="#" class="deleoption">&times;</a>';
        }
