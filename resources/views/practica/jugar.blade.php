    ...
    function doQuest(){
        ...
        if(dataquestion.options.length>1){
            ...
            for (let index = 0; index < dataquestion.options.length; index++) {
                ...
                textanswer += '<input style="opacity:0;position: absolute" type="radio" '+strrequired+' class="form-radio" name="useranswer" value="'+questoption+'">';
                textanswer += '<span class="notranslate text-2xl">';
